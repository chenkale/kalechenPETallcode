    ...
    while (User_Input == 1):
        for point in points:
            ...
            # the 2D stage is mounted onto the top of the scanner 
                ...
                string = 'G1 X{} Y{} F{} ; \n'.format(198+point[0],215+point[1],feedrate)
        ...
        string = 'G1 X{} Y{} F{} ; \n'.format(198+points[0][0],215+points[0][1],5000)
        ser.write(str.encode(string))
        ...
        for j, point in enumerate(points):
            ...
            # the 2D stage is mounted onto the top of the scanner 
                ...
                if (j < len(points) - 10 and (points[j-1][0] - point[0] > 20 or  points[j-1][0] - point[0] < -20)):
                    ...
                    #print("\n" + "yes" + "\n \n \n \n \n \n")
                    feedrateSPEED = 30000
                    string = 'G1 X{} Y{} F{} ; \n'.format(198+point[0],215+point[1],feedrateSPEED)
...
#        source_loc = read_loc()
    ...
    if(user_type_run == "P"):
        distance = get_source_loc_dots.main(radius) # Get's circle shape
        source_loc = read_loc()
