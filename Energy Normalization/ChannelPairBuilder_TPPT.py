...
debug = False
dir = "NewRuns/TPPT/" # Data file directory, if different from working directory
#file_name = "NormalizationRun14_210mmSep_45mmSourceHeight_coinc"
file_name = "NormalizationRun1_circle_calibration_30min_ccw_Run1_TrigOn_coinc.dat"
#file_name_2 = "NormalizationRun2_circle_calibration_30min_ccw_Run2_TrigOn_coinc.dat"
...
def reduce_channel_pairs(UniqueCPs, debug=False):
    ...
    """
    num_counts = 50 # Initial threshold
